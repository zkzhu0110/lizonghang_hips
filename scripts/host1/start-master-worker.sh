...
# container
IMAGE_NAME=hips
CONTAINER_NAME=hips-master-worker
HOST_NAME=master-worker
CONTAINER_PORT=9094
SSH_PORT=9004
...
sudo docker run -dit \
                ...
                -e DMLC_ROLE_MASTER_WORKER=$DMLC_ROLE_MASTER_WORKER \
...
# re-allocate cpu and memmory
# NOTE: this will disable nvidia-driver
sudo docker update -c 4 -m 2G $CONTAINER_NAME